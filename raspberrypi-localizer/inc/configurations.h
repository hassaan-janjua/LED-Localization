...
#define LUMINENCE_THRESH_MAX      0.9
#define LUMINENCE_THRESH_MIN      0.005
#define LUMINENCE_THRESH_DELTA    0.002
#define FRAME_ONES_THRESH         500
...
//#define FRAME_WIDTH               (1920/2)
//#define FRAME_HEIGHT              (1088/2)
